    ...
    <div className="min-h-screen w-full flex bg-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative px-8 sm:px-16 md:px-24 justify-center">
        ...
        <div className="w-full max-w-[380px] mx-auto">
          <div className="mb-12">
            <h1 className="text-3xl font-[1000] tracking-tight text-black mb-3">Welcome back</h1>
            <p className="text-sm font-medium text-slate-500">Sign in to your RenderReply account to continue.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-[10px] font-black uppercase tracking-[0.1em] text-slate-400 hover:text-black transition-colors">Forgot?</Link>
              </div>
              <Input 
                type="password" 
                placeholder="••••••••"
          ...
          <p className="text-[11px] font-medium text-slate-500 mt-8 text-center">
